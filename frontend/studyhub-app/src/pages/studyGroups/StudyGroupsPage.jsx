...
function GroupDetailView({ groupId }) {
  ...
  const isCreator = activeGroup.createdBy === activeGroup.createdBy // Compare group's creator
        ...
        <div style={pageShell('app', 26, 48)}>
          <main id="main-content">
            ...
            <div style={styles.tabContent}>
              {activeTab === 'overview' && (
                <div style={styles.placeholder}>Overview content coming soon</div>
              )}
              {activeTab === 'resources' && (
                <div style={styles.placeholder}>Resources content coming soon</div>
              )}
              {activeTab === 'sessions' && (
                <div style={styles.placeholder}>Sessions content coming soon</div>
              )}
              {activeTab === 'discussions' && (
                <div style={styles.placeholder}>Discussions content coming soon</div>
              )}
              {activeTab === 'members' && (
                <div style={styles.placeholder}>Members content coming soon</div>
              )}
            </div>
          </main>
        </div>
