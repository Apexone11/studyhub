    ...
    { key: 'actions', label: 'Actions', render: (r) => {
      ...
      return (
        <div style={{ display: 'flex', gap: 6 }}>
          <button className="admin-btn admin-btn--success admin-btn--sm" onClick={() => onReviewAppeal(r.id, 'approve')}>Approve</button>
          <button className="admin-btn admin-btn--danger admin-btn--sm" onClick={() => onReviewAppeal(r.id, 'reject')}>Reject</button>
        </div>
      )
    }},
  ]
