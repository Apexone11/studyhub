...
const s = {
  page: { minHeight: '100vh', fontFamily: 'Arial, sans-serif', background: '#fff', color: '#111827' },
  ...
  ctaPrimary: { background: '#2563eb', color: '#fff', textDecoration: 'none', padding: '14px 32px', borderRadius: 10, fontWeight: 'bold', fontSize: 15 },
  ...
  sectionH2: { fontSize: 'clamp(24px, 3vw, 36px)', fontWeight: 'bold', color: '#1e3a5f', margin: '0 0 40px', textAlign: 'center' },
  storyGrid: { display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 280px', gap: 48, alignItems: 'start' },
  storyText: {},
  p: { fontSize: 16, color: '#374151', lineHeight: 1.8, margin: '0 0 16px' },
  storyStats: { display: 'flex', flexDirection: 'column', gap: 16 },
  statCard: { background: '#f0f4f8', borderRadius: 14, padding: '24px 28px', textAlign: 'center' },
  statValue: { fontSize: 42, fontWeight: 'bold', color: '#2563eb', marginBottom: 4 },
  statLabel: { fontSize: 13, color: '#6b7280' },
  goalsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 20 },
  goalCard: { background: '#fff', border: '1px solid #e5e7eb', borderRadius: 14, padding: '28px 24px' },
  goalIconWrap: { width: 44, height: 44, borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
  goalTitle: { fontSize: 16, fontWeight: 'bold', color: '#1e3a5f', margin: '0 0 8px' },
  goalDesc: { fontSize: 14, color: '#6b7280', margin: 0, lineHeight: 1.6 },
  stepsRow: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 24 },
  stepCard: { background: '#f8fafc', borderRadius: 14, padding: '32px 24px', textAlign: 'center' },
  stepNum: { fontSize: 40, fontWeight: 'bold', color: '#e5e7eb', marginBottom: 16 },
  stepTitle: { fontSize: 18, fontWeight: 'bold', color: '#1e3a5f', margin: '0 0 12px' },
  stepDesc: { fontSize: 14, color: '#6b7280', margin: 0, lineHeight: 1.7 },
  roadmapGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 },
  roadmapCol: { background: '#fff', border: '1px solid #e5e7eb', borderRadius: 14, padding: '28px 24px' },
  roadmapTitle: { fontSize: 18, fontWeight: 'bold', margin: '0 0 20px' },
  roadmapList: { listStyle: 'none', padding: 0, margin: 0 },
  roadmapItem: { fontSize: 14, color: '#374151', padding: '8px 0', borderBottom: '1px solid #f3f4f6', display: 'flex', alignItems: 'flex-start' },
  teamCard: { display: 'flex', alignItems: 'flex-start', gap: 20, background: '#f8fafc', borderRadius: 16, padding: '28px 32px', marginBottom: 20 },
  teamAvatar: { width: 56, height: 56, borderRadius: '50%', background: '#2563eb', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, fontWeight: 'bold', flexShrink: 0 },
  teamName: { fontSize: 18, fontWeight: 'bold', color: '#1e3a5f', marginBottom: 4 },
  teamRole: { fontSize: 13, color: '#6b7280', marginBottom: 10 },
  teamBio: { fontSize: 14, color: '#374151', margin: 0, lineHeight: 1.7 },
  openSourceNote: { fontSize: 14, color: '#6b7280', textAlign: 'center' },
