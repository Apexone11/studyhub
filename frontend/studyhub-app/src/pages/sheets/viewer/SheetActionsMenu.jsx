...
const dropdownSectionLabel = {
  ...
  letterSpacing: '0.04em', padding: '6px 12px 2px', userSelect: 'none',
}

const dropdownDivider = {
  height: 1, background: 'var(--sh-border)', margin: '4px 0',
}
      ...
      <div style={{ position: 'relative' }} ref={menuRef}>
        ...
        {menuOpen && (
          <div style={secondaryDropdown()} role="menu" aria-label="Sheet actions">
            ...
            <button type="button" onClick={() => { handleShare(); setMenuOpen(false) }} style={dropdownItem()} role="menuitem">
            ...
            {sheet.hasAttachment && (
              <Link to={`/preview/sheet/${sheet.id}`} style={dropdownItem()} onClick={() => setMenuOpen(false)} role="menuitem">
                <IconEye size={14} />
                Preview attachment
              </Link>
            )}
            ...
            {isHtmlSheet && (sheet.status !== 'pending_review' || canEdit) && (
              <Link to={`/sheets/preview/html/${sheet.id}`} style={dropdownItem()} onClick={() => setMenuOpen(false)} role="menuitem">
                <IconEye size={14} />
