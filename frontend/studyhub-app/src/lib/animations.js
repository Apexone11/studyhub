...
// call so no rAF loop runs. The CSS-side disable in index.css covers
// transitions / animations / will-change; this JS-side gate covers
// anime.js + the per-helper rAF loops the CSS rule can't reach.
