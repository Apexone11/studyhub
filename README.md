...
StudyHub V1.5.0 is the current live release. See [ROADMAP.md](ROADMAP.md) for what's next.

### V1.5.0 Highlights
- SheetLab: full version control with commits, diffs, and merge workflow
- Contribution flow: fork, improve, submit, review, and merge
- Profile system with cover images, pinned sheets, activity heatmap, and badges
- Content moderation engine with AI scanning, admin review, strikes, and appeals
- WebAuthn passkey authentication
- Google OAuth login
- Global search across sheets, courses, and users
- HTML study sheet support with tiered risk classification
