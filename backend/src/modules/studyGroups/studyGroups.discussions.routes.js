 ...
 */
router.get('/:postId', readLimiter, requireAuth, async (req, res) => {
  try {
    const groupId = parseId(req.params.id)
 ...
 */
router.patch('/:postId', writeLimiter, requireAuth, async (req, res) => {
  try {
    const groupId = parseId(req.params.id)
    const postId = parseId(req.params.postId)
 ...
 */
router.delete('/:postId', writeLimiter, requireAuth, async (req, res) => {
  try {
    const groupId = parseId(req.params.id)
    const postId = parseId(req.params.postId)
 ...
 * Add reply to post
 */
router.post('/:postId/replies', writeLimiter, requireAuth, async (req, res) => {
  try {
    const groupId = parseId(req.params.id)
    const postId = parseId(req.params.postId)
 ...
 * Update reply
 */
router.patch('/:postId/replies/:replyId', writeLimiter, requireAuth, async (req, res) => {
  try {
    const groupId = parseId(req.params.id)
    const postId = parseId(req.params.postId)
 ...
 * Delete reply
 */
router.delete('/:postId/replies/:replyId', writeLimiter, requireAuth, async (req, res) => {
  try {
    const groupId = parseId(req.params.id)
    const postId = parseId(req.params.postId)
    const replyId = parseId(req.params.replyId)
 ...
 */
router.patch('/:postId/resolve', writeLimiter, requireAuth, async (req, res) => {
  try {
    const groupId = parseId(req.params.id)
    const postId = parseId(req.params.postId)
 ...
 */
router.post('/:postId/upvote', writeLimiter, requireAuth, async (req, res) => {
  try {
    const groupId = parseId(req.params.id)
    const postId = parseId(req.params.postId)
    if (groupId === null || postId === null) {
 ...
 */
router.post('/:postId/replies/:replyId/upvote', writeLimiter, requireAuth, async (req, res) => {
  try {
    const groupId = parseId(req.params.id)
    const replyId = parseId(req.params.replyId)
