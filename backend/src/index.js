...
console.log('[env-check] EMAIL_TRANSPORT=', process.env.EMAIL_TRANSPORT)
console.log('[env-check] has_RESEND_API_KEY=', Boolean(process.env.RESEND_API_KEY))
console.log('[env-check] EMAIL_FROM=', process.env.EMAIL_FROM)
console.log('[env-check] ENV_CANARY=', process.env.ENV_CANARY)
